...
def set_all_entrance_rules(world: NovaLandsWorld) -> None:
    ...
    researches_to_researches2 = world.get_entrance("Researches to Researches2")
    set_rule(researches_to_researches2, lambda state: state.has_all(["Automation I", "Automation II"], world.player) or state.has("Hand Logic", world.player))
    researches_to_captures = world.get_entrance("Researches to Captures")
    set_rule(researches_to_captures, lambda state: state.has_all(["Ranching II","Steel"], world.player))
    researches_to_museum = world.get_entrance("Researches to Museum")
    set_rule(researches_to_museum, lambda state: state.has_all(["Desert Island", "Encampment Island"], world.player))
...
def set_all_location_rules(world: NovaLandsWorld) -> None:
    ...
    set_rule(world.get_location("Museum: 1 Grass Diorama"), lambda state: state.has_from_list_unique(["Stone", "Twig", "Modular Brick", "Iron Ingot", "Antork Capsule"], world.player, 1))
    set_rule(world.get_location("Museum: 2 Grass Dioramas"), lambda state: state.has_from_list_unique(["Stone", "Twig", "Modular Brick", "Iron Ingot", "Antork Capsule"], world.player, 2))
    set_rule(world.get_location("Museum: 3 Grass Dioramas"), lambda state: state.has_from_list_unique(["Stone", "Twig", "Modular Brick", "Iron Ingot", "Antork Capsule"], world.player, 3))
    set_rule(world.get_location("Museum: 4 Grass Dioramas"), lambda state: state.has_from_list_unique(["Stone", "Twig", "Modular Brick", "Iron Ingot", "Antork Capsule"], world.player, 4))
    set_rule(world.get_location("Museum: 5 Grass Dioramas"), lambda state: state.has_from_list_unique(["Stone", "Twig", "Modular Brick", "Iron Ingot", "Antork Capsule"], world.player, 5))
    set_rule(world.get_location("Museum: 1 Rock Diorama"), lambda state: state.has_from_list_unique(["Iron Ore", "Copper Ore", "Copper Ingot", "Steel", "Carancrab Capsule"], world.player, 1))
    set_rule(world.get_location("Museum: 2 Rock Dioramas"), lambda state: state.has_from_list_unique(["Iron Ore", "Copper Ore", "Copper Ingot", "Steel", "Carancrab Capsule"], world.player, 2))
    set_rule(world.get_location("Museum: 3 Rock Dioramas"), lambda state: state.has_from_list_unique(["Iron Ore", "Copper Ore", "Copper Ingot", "Steel", "Carancrab Capsule"], world.player, 3))
    set_rule(world.get_location("Museum: 4 Rock Dioramas"), lambda state: state.has_from_list_unique(["Iron Ore", "Copper Ore", "Copper Ingot", "Steel", "Carancrab Capsule"], world.player, 4))
    set_rule(world.get_location("Museum: 5 Rock Dioramas"), lambda state: state.has_from_list_unique(["Iron Ore", "Copper Ore", "Copper Ingot", "Steel", "Carancrab Capsule"], world.player, 5))
    set_rule(world.get_location("Museum: 1 Desert Diorama"), lambda state: state.has_from_list_unique(["Sand", "Cactus Flower", "Glass", "Lens", "Scortixa Capsule"], world.player, 1))
    set_rule(world.get_location("Museum: 2 Desert Dioramas"), lambda state: state.has_from_list_unique(["Sand", "Cactus Flower", "Glass", "Lens", "Scortixa Capsule"], world.player, 2))
    set_rule(world.get_location("Museum: 3 Desert Dioramas"), lambda state: state.has_from_list_unique(["Sand", "Cactus Flower", "Glass", "Lens", "Scortixa Capsule"], world.player, 3))
    set_rule(world.get_location("Museum: 4 Desert Dioramas"), lambda state: state.has_from_list_unique(["Sand", "Cactus Flower", "Glass", "Lens", "Scortixa Capsule"], world.player, 4))
    set_rule(world.get_location("Museum: 5 Desert Dioramas"), lambda state: state.has_from_list_unique(["Sand", "Cactus Flower", "Glass", "Lens", "Scortixa Capsule"], world.player, 5))
    set_rule(world.get_location("Museum: 1 Sea Diorama"), lambda state: state.has_from_list_unique(["Stretshroom", "Plastic", "Plasteel", "Electronic Parts", "Jellyblue Capsule"], world.player, 1))
    set_rule(world.get_location("Museum: 2 Sea Dioramas"), lambda state: state.has_from_list_unique(["Stretshroom", "Plastic", "Plasteel", "Electronic Parts", "Jellyblue Capsule"], world.player, 2))
    set_rule(world.get_location("Museum: 3 Sea Dioramas"), lambda state: state.has_from_list_unique(["Stretshroom", "Plastic", "Plasteel", "Electronic Parts", "Jellyblue Capsule"], world.player, 3))
    set_rule(world.get_location("Museum: 4 Sea Dioramas"), lambda state: state.has_from_list_unique(["Stretshroom", "Plastic", "Plasteel", "Electronic Parts", "Jellyblue Capsule"], world.player, 4))
    set_rule(world.get_location("Museum: 5 Sea Dioramas"), lambda state: state.has_from_list_unique(["Stretshroom", "Plastic", "Plasteel", "Electronic Parts", "Jellyblue Capsule"], world.player, 5))
    set_rule(world.get_location("Museum: 1 Forest Diorama"), lambda state: state.has_from_list_unique(["Sweetcane", "Cornillia Flower", "Biofuel Bottle", "Lubricant Oil", "Birbee Capsule"], world.player, 1))
    set_rule(world.get_location("Museum: 2 Forest Dioramas"), lambda state: state.has_from_list_unique(["Sweetcane", "Cornillia Flower", "Biofuel Bottle", "Lubricant Oil", "Birbee Capsule"], world.player, 2))
    set_rule(world.get_location("Museum: 3 Forest Dioramas"), lambda state: state.has_from_list_unique(["Sweetcane", "Cornillia Flower", "Biofuel Bottle", "Lubricant Oil", "Birbee Capsule"], world.player, 3))
    set_rule(world.get_location("Museum: 4 Forest Dioramas"), lambda state: state.has_from_list_unique(["Sweetcane", "Cornillia Flower", "Biofuel Bottle", "Lubricant Oil", "Birbee Capsule"], world.player, 4))
    set_rule(world.get_location("Museum: 5 Forest Dioramas"), lambda state: state.has_from_list_unique(["Sweetcane", "Cornillia Flower", "Biofuel Bottle", "Lubricant Oil", "Birbee Capsule"], world.player, 5))
    set_rule(world.get_location("Museum: 1 Snow Diorama"), lambda state: state.has_from_list_unique(["Juice Ball", "Jelly", "Super Cooler Fluid", "Computer Module", "Jellypink Capsule"], world.player, 1))
    set_rule(world.get_location("Museum: 2 Snow Dioramas"), lambda state: state.has_from_list_unique(["Juice Ball", "Jelly", "Super Cooler Fluid", "Computer Module", "Jellypink Capsule"], world.player, 2))
    set_rule(world.get_location("Museum: 3 Snow Dioramas"), lambda state: state.has_from_list_unique(["Juice Ball", "Jelly", "Super Cooler Fluid", "Computer Module", "Jellypink Capsule"], world.player, 3))
    set_rule(world.get_location("Museum: 4 Snow Dioramas"), lambda state: state.has_from_list_unique(["Juice Ball", "Jelly", "Super Cooler Fluid", "Computer Module", "Jellypink Capsule"], world.player, 4))
    set_rule(world.get_location("Museum: 5 Snow Dioramas"), lambda state: state.has_from_list_unique(["Juice Ball", "Jelly", "Super Cooler Fluid", "Computer Module", "Jellypink Capsule"], world.player, 5))
    set_rule(world.get_location("Museum: 1 Metallic Diorama"), lambda state: state.has_from_list_unique(["Titanium Ingot", "Reinforced Super Metal", "Advanced Electronic Parts", "Supercomputer Module", "Arabeetle Capsule"], world.player, 1))
    set_rule(world.get_location("Museum: 2 Metallic Dioramas"), lambda state: state.has_from_list_unique(["Titanium Ingot", "Reinforced Super Metal", "Advanced Electronic Parts", "Supercomputer Module", "Arabeetle Capsule"], world.player, 2))
    set_rule(world.get_location("Museum: 3 Metallic Dioramas"), lambda state: state.has_from_list_unique(["Titanium Ingot", "Reinforced Super Metal", "Advanced Electronic Parts", "Supercomputer Module", "Arabeetle Capsule"], world.player, 3))
    set_rule(world.get_location("Museum: 4 Metallic Dioramas"), lambda state: state.has_from_list_unique(["Titanium Ingot", "Reinforced Super Metal", "Advanced Electronic Parts", "Supercomputer Module", "Arabeetle Capsule"], world.player, 4))
    set_rule(world.get_location("Museum: 5 Metallic Dioramas"), lambda state: state.has_from_list_unique(["Titanium Ingot", "Reinforced Super Metal", "Advanced Electronic Parts", "Supercomputer Module", "Arabeetle Capsule"], world.player, 5))
    set_rule(world.get_location("Museum: 1 Behemittium Diorama"), lambda state: state.has_from_list_unique(["Behemittium", "Blood Flower", "Super Control Unit", "Hypercomputer Module", "Moschy Capsule"], world.player, 1))
    set_rule(world.get_location("Museum: 2 Behemittium Dioramas"), lambda state: state.has_from_list_unique(["Behemittium", "Blood Flower", "Super Control Unit", "Hypercomputer Module", "Moschy Capsule"], world.player, 2))
    set_rule(world.get_location("Museum: 3 Behemittium Dioramas"), lambda state: state.has_from_list_unique(["Behemittium", "Blood Flower", "Super Control Unit", "Hypercomputer Module", "Moschy Capsule"], world.player, 3))
    set_rule(world.get_location("Museum: 4 Behemittium Dioramas"), lambda state: state.has_from_list_unique(["Behemittium", "Blood Flower", "Super Control Unit", "Hypercomputer Module", "Moschy Capsule"], world.player, 4))
    set_rule(world.get_location("Museum: 5 Behemittium Dioramas"), lambda state: state.has_from_list_unique(["Behemittium", "Blood Flower", "Super Control Unit", "Hypercomputer Module", "Moschy Capsule"], world.player, 5))

    set_rule(world.get_location("Antork Capsule"), lambda state: state.has_all(["Grass Island"], world.player))
    set_rule(world.get_location("Carancrab Capsule"), lambda state: state.has_all(["Rock Island"], world.player))
    set_rule(world.get_location("Scortixa Capsule"), lambda state: state.has_all(["Desert Island"], world.player))
    set_rule(world.get_location("Jellyblue Capsule"), lambda state: state.has_all(["Sea Island"], world.player))
    set_rule(world.get_location("Birbee Capsule"), lambda state: state.has_all(["Forest Island"], world.player))
    set_rule(world.get_location("Jellypink Capsule"), lambda state: state.has_all(["Snow Island"], world.player))
    set_rule(world.get_location("Arabeetle Capsule"), lambda state: state.has_all(["Metallic Island"], world.player))
    set_rule(world.get_location("Moschy Capsule"), lambda state: state.has_all(["Behemittium Island"], world.player))

    set_rule(world.get_location("Sand"), lambda state: state.has_all(["Desert Island"], world.player))
    set_rule(world.get_location("Cactus Flower"), lambda state: state.has_all(["Desert Island"], world.player))
    set_rule(world.get_location("Lens"), lambda state: state.has_all(["Glass", "Iron Ingot", "Glass Works", "Electric Furnace"], world.player))
    set_rule(world.get_location("Stretshroom"), lambda state: state.has_all(["Sea Island"], world.player))
    set_rule(world.get_location("Sweetcane"), lambda state: state.has_all(["Forest Island"], world.player))
    set_rule(world.get_location("Cornillia Flower"), lambda state: state.has_all(["Forest Island"], world.player))
    set_rule(world.get_location("Biofuel Bottle"), lambda state: state.has_all(["Liquids I", "Industrial Refinery", "Sweetcane","Glass"], world.player))
    set_rule(world.get_location("Lubricant Oil"), lambda state: state.has_all(["Liquids I", "Industrial Refinery", "Cornillia Flower", "Glass"], world.player))
    set_rule(world.get_location("Juice Ball"), lambda state: state.has_all(["Snow Island"], world.player))
    set_rule(world.get_location("Jelly"), lambda state: state.has_all(["Snow Island"], world.player) and state.has_any(["Energy Rifle", "Fighter Bot"], world.player))
    set_rule(world.get_location("Super Cooler Fluid"), lambda state: state.has_all(["Glass Works", "Industrial Refinery", "Cactus Flower", "Juice Ball", "Glass"], world.player))
    set_rule(world.get_location("Blood Flower"), lambda state: state.has_all(["Behemittium Island"], world.player))
    set_rule(world.get_location("Super Control Unit"), lambda state: state.has_all(["Hypercomputer", "Assembler", "Advanced Electronic Parts", "Behemittium", "Reinforced Super Metal", "Electric Furnace"], world.player))
    ...
    set_rule(world.get_location("Glass"), lambda state: state.has_all(["Mass Production II", "Electric Furnace", "Sand"], world.player))
    set_rule(world.get_location("Plastic"), lambda state: state.has_all(["Advanced Production II", "Industrial Refinery", "Stretshroom"], world.player))
    ...
    set_rule(world.get_location("Advanced Electronic Parts"), lambda state: state.has_all(["Complex Production II", "Assembler", "Titanium Ingot", "Computer Module", "Electronic Parts", "Lens"], world.player))
    set_rule(world.get_location("Reinforced Super Metal"), lambda state: state.has_all(["Complex Production II", "Industrial Refinery", "Titanium Ingot", "Plasteel", "Jelly", "Furnace", "Twig", "Furnace"], world.player))
    set_rule(world.get_location("Behemittium"), lambda state: state.has_all(["Superhard Minerals", "Behemittium Island"], world.player))
    set_rule(world.get_location("Supercomputer Module"), lambda state: state.has_all(["Supercomputer", "Assembler", "Advanced Electronic Parts", "Reinforced Super Metal", "Super Cooler Fluid"], world.player))
    set_rule(world.get_location("Behemittium Battery"), lambda state: state.has_all(["Nuclear Tech", "Industrial Refinery", "Reinforced Super Metal", "Biofuel Bottle", "Behemittium", "Electric Furnace"], world.player))
    set_rule(world.get_location("Hypercomputer Module"), lambda state: state.has_all(["Hypercomputer", "Assembler", "Supercomputer Module", "Behemittium Battery", "Supercomputer Module"], world.player))
...
def set_completion_condition(world: NovaLandsWorld) -> None:
    ...
    if world.options.goal == 1:
        world.multiworld.completion_condition[world.player] = lambda state: state.has_all(["Desert Island", "Encampment Island"], world.player) and state.has_from_list_unique(["Stone", "Twig", "Modular Brick", "Iron Ingot", "Antork Capsule", "Iron Ore", "Copper Ore", "Copper Ingot", "Steel", "Carancrab Capsule", "Sand", "Cactus Flower", "Glass", "Lens", "Scortixa Capsule", "Stretshroom", "Plastic", "Plasteel", "Electronic Parts", "Jellyblue Capsule", "Sweetcane", "Cornillia Flower", "Biofuel Bottle", "Lubricant Oil", "Birbee Capsule", "Juice Ball", "Jelly", "Super Cooler Fluid", "Computer Module", "Jellypink Capsule", "Titanium Ingot", "Reinforced Super Metal", "Advanced Electronic Parts", "Supercomputer Module", "Arabeetle Capsule", "Behemittium", "Blood Flower", "Super Control Unit", "Hypercomputer Module", "Moschy Capsule"], world.player, world.options.museum_diorama_count)
