...
from . import options as nova_lands_options  # rename due to a name conflict with World.options

# NovaLands will go through all the parts of the world api one step at a time,
...
class NovaLandsWorld(World):
    ...
    web = web_world.NovaLandsWebWorld()

    # This is how we associate the options defined in our options.py with our world.
    # (Note: options.py has been imported as "nova_lands_options" at the top of this file to avoid a name conflict)
    options_dataclass = nova_lands_options.NovaLandsOptions
    options: nova_lands_options.NovaLandsOptions  # Common mistake: This has to be a colon (:), not an equals sign (=).
    ...
    def create_item(self, name: str) -> items.NovaLandsItem:
